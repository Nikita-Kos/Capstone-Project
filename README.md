...
| [Предсказание разновидности пингвинов](https://github.com/Nikita-Kos/Capstone-Project/tree/main/5.%20Project) | Создать модель дерева решений, которая поможет нам определять вид пингвина на основе его физических атрибутов, чтобы исследователи могли с помощью этой модели классифицировать пингвинов, без необходимости привлечения опытного биолога..| *Pandas*, *Seaborn*, *sklearn*| 
